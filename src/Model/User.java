...
public abstract class User implements UserService {
    ...
    public String getUserFullName() {
        return " І'мя: " + getFirstName() + ",Прізвеще: " + getLastName();
    }
    ...
    public boolean login(String username, String password) {
        ...
        if (UserManager.getLoggedInUsers().contains(this)) {
            System.out.println("Ви вже авторизовані !");
            return true;
        } else {
            for (User user : UserManager.getAllUsers()) {
                if (user.getEmail().equals(email) && user.getPassword().equals(password) && user.getStatus() == UserStatus.ACTIVE) {
                    ...
                    if (UserManager.isLoggedIn(this)) {
                        System.out.println("Користувач :" + getUserFullName() + " успішно увійшов до системи. " +
                                "Користувач роль: " + getUserRoleAsString());
                        return true;
                    } else {
                        System.out.println("Сталася помилка входу !");
                        return false;
                    }
                }
            }
        ...
        System.out.println("Невірні облікові даннію");
        return false;
    }
    ...
    public void logout() {
        if (UserManager.getLoggedInUsers().contains(this))
            ...
            System.out.println("Ви не зареєстровані  !");
    }
